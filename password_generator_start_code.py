...
#print(f'You have chosen {no_of_letters}')
...
no_of_digits=int(input("How many digits would you like your password to be?  "))
...
final_password_list = password_symbols_list + password_character_list + password_digits_list

#ahuffling my final password list
...
#       append the character to the string_password
    string_password = string_password + character
